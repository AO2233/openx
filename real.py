...
from tools import set_grasper_open_real, set_joint_real
...
def move_to_point_line(
    model_id, target_position, target_orientation=None, num_steps=15
):
    if target_orientation is not None:
        print(
            "target_orientation is not None, it's dengerous to use move_to_point_line."
        )
